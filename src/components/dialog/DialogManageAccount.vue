<template>
  <v-dialog v-model="showManageAccountDialog" width="800" @keydown.stop @keyup.stop>
    <v-sheet class="pa-3">
      <!-- Compact Header -->
                ...
                <v-col cols="5">
                  ...
                  >
                    <v-list-item
                      ...
                      :key="u.username"
                      :value="u.username"
                      :active="u.username === selected?.username"
                      class="align-left"
                      @click="selectUser(u)"
                    >
                      <template #prepend>
                        <v-icon v-if="!u.children" :color="u.isActive ? '#76FF03' : null">
                          mdi-account
                        </v-icon>
                      </template>
                      <span>
                      ...
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            ...
                            @on-revert="handleClick('password')"
                          />
                        </v-col>
                      </v-row>
