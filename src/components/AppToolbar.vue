<template>
  ...
  >
    ...
    <template v-if="$vuetify.display.smAndUp && toolbar.expanded">
...
<script setup>
  ...
  const handleMouseDown = (event) => {
    // Always delegate to drag handle for click/double-click detection
    // The drag composable will handle pin/unpin and double-click centering
