<template>
  ...
  <div
    ...
    class="terminal-full-width"
    :class="{ 'with-drawer': settings.isVisible }"
  >
...
<script setup>
  ...
  const {
    terminalWidth: sshTerminalWidth,
    startResize,
    handleResizeDoubleClick,
  } = useTerminalResize(50);
  const { terminalHeight, startVerticalResize } = useTerminalVerticalResize(300);

  // Computed properties
  const hasActiveTerminals = computed(() => props.showSSHTerminal || props.showSerial);
