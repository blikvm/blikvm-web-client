<template>
  ...
  <template v-if="showMobileKeyboard">
    ...
    <v-row no-gutters dense align="center" class="w-100" style="min-height: 25px">
      ...
      <v-col
        cols="auto"
        class="d-flex justify-end align-center position-absolute"
        style="right: 0; top: 0; bottom: 0; z-index: 1"
      >
        <v-btn
          v-ripple
    ...
    <v-row dense no-gutters class="mt-1">
      <v-col cols="12" class="d-flex justify-center">
        <div class="mobile-keyboard-container">
          <!-- Text input area -->
          <v-card
            class="mobile-keyboard-input mb-2"
          ...
          <v-row dense no-gutters class="mb-2">
            <v-col cols="4" class="px-1">
              <v-btn block size="small" color="#76FF03" variant="outlined" @click="sendMobileText">
                {{ $t('common.send') }}
              </v-btn>
            </v-col>
            <v-col cols="4" class="px-1">
